...
var Salvation={};Salvation.Core={};Salvation.Video={};Salvation.Scene={};Salvation.Gui={};Salvation.Device=function(p_Canvas){this.Type="Salvation.Device";this.Canvas=p_Canvas;this.GlContext=null;if(p_Canvas.addEventListener)
...
this.Values[l_I]=0;this.Import=Salvation.Core.Matrix4_Import;this.Perspective=Salvation.Core.Matrix4_Perspective;this.Rotate=Salvation.Core.Matrix4_Rotate;this.Translate=Salvation.Core.Matrix4_Translate
